...
class Window(QWidget):
    ...
    def button(self):
        ...
        button.move(50, 50)
        button.clicked.connect(self.buttonFuntion)
    
    def buttonFuntion(self):
        print("hello world")
    ...
    def label(self):
        ...
        button1.clicked.connect(self.button1Func)
    ...
    def entry(self):
        ...
        button1.move(300, 75)
        button1.clicked.connect(self.saveFunc)
    ...
    def messageBox(self):
        ...
        button1.move(500, 50)
        button1.clicked.connect(self.messageFunc) 
        
        button2 = QPushButton("Message2", self)
        button2.move(500, 75)
        button2.clicked.connect(self.messageFunc2) 
    ...
    def Font(self):
        ...
        button.move(700, 50)
        button.clicked.connect(self.setFont) 
